...
__attribute__((swift_name("ArrayTest")))
@interface SharedArrayTest : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property SharedKotlinArray<NSString *> *array __attribute__((swift_name("array")));
@property NSMutableArray<NSString *> *arrayList __attribute__((swift_name("arrayList")));
@property (readonly) NSArray<NSString *> *list __attribute__((swift_name("list")));
@property NSMutableArray<NSString *> *mutableList __attribute__((swift_name("mutableList")));
@end;
...
@protocol SharedKoruScopeProvider
@required
...
@interface SharedMainScopeProvider : SharedBase <SharedKoruScopeProvider>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) id<SharedKotlinx_coroutines_coreCoroutineScope> scope __attribute__((swift_name("scope")));
@end;
...
*/
- (void)fetchWithCompletionHandler:(void (^)(NSArray<SharedPost *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("fetch(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostRepositoryImpl")))
@interface SharedPostRepositoryImpl : SharedBase <SharedPostRepository>
- (instancetype)initWithClient:(SharedApiClient *)client __attribute__((swift_name("init(client:)"))) __attribute__((objc_designated_initializer));
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)performRequest:(SharedRequest<id> *)request headers:(NSDictionary<NSString *, NSString *> *)headers completionHandler:(void (^)(id _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("perform(request:headers:completionHandler:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiException.Decoding")))
@interface SharedApiExceptionDecoding : SharedApiException
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)decoding __attribute__((swift_name("init()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiException.Network")))
@interface SharedApiExceptionNetwork : SharedApiException
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)network __attribute__((swift_name("init()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ApiException.Response")))
@interface SharedApiExceptionResponse : SharedApiException
...
- (SharedApiExceptionResponse *)doCopyStatusCode:(int32_t)statusCode __attribute__((swift_name("doCopy(statusCode:)")));
...
@interface SharedHTTPMethod : SharedKotlinEnum<SharedHTTPMethod *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly) SharedHTTPMethod *get __attribute__((swift_name("get")));
@property (class, readonly) SharedHTTPMethod *post __attribute__((swift_name("post")));
@property (class, readonly) SharedHTTPMethod *put __attribute__((swift_name("put")));
@property (class, readonly) SharedHTTPMethod *patch __attribute__((swift_name("patch")));
@property (class, readonly) SharedHTTPMethod *delete_ __attribute__((swift_name("delete_")));
@property (class, readonly) SharedHTTPMethod *head __attribute__((swift_name("head")));
@property (class, readonly) SharedHTTPMethod *options __attribute__((swift_name("options")));
+ (SharedKotlinArray<SharedHTTPMethod *> *)values __attribute__((swift_name("values()")));
- (SharedKtor_httpHttpMethod *)toKtor __attribute__((swift_name("toKtor()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Request")))
@interface SharedRequest<T> : SharedBase
- (instancetype)initWithPath:(NSString *)path method:(SharedHTTPMethod *)method headers:(NSDictionary<NSString *, NSString *> *)headers __attribute__((swift_name("init(path:method:headers:)"))) __attribute__((objc_designated_initializer));
- (NSString *)component1 __attribute__((swift_name("component1()")));
- (SharedHTTPMethod *)component2 __attribute__((swift_name("component2()")));
- (NSDictionary<NSString *, NSString *> *)component3 __attribute__((swift_name("component3()")));
- (SharedRequest<T> *)doCopyPath:(NSString *)path method:(SharedHTTPMethod *)method headers:(NSDictionary<NSString *, NSString *> *)headers __attribute__((swift_name("doCopy(path:method:headers:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostApi")))
@interface SharedPostApi : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)postApi __attribute__((swift_name("init()")));
- (SharedRequest<NSArray<SharedPost *> *> *)posts __attribute__((swift_name("posts()")));
@end;

__attribute__((swift_name("PostListFetchIosUseCase")))
@protocol SharedPostListFetchIosUseCase
@required
- (SharedKoruSuspendWrapper<SharedPostList *> *)invoke __attribute__((swift_name("invoke()")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostListFetchIosUseCaseImpl")))
@interface SharedPostListFetchIosUseCaseImpl : SharedBase <SharedPostListFetchIosUseCase>
- (instancetype)initWithWrapped:(SharedPostListFetchUseCaseImpl *)wrapped __attribute__((swift_name("init(wrapped:)"))) __attribute__((objc_designated_initializer));
- (SharedKoruSuspendWrapper<SharedPostList *> *)invoke __attribute__((swift_name("invoke()")));
@end;

__attribute__((swift_name("PostListFetchUseCase")))
@protocol SharedPostListFetchUseCase
@required
...
/**
 ...
 Other uncaught Kotlin exceptions are fatal.
*/
- (void)invokeWithCompletionHandler:(void (^)(SharedPostList * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("invoke(completionHandler:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostListFetchUseCaseImpl")))
@interface SharedPostListFetchUseCaseImpl : SharedBase <SharedPostListFetchUseCase>
- (instancetype)initWithPostRepository:(id<SharedPostRepository>)postRepository __attribute__((swift_name("init(postRepository:)"))) __attribute__((objc_designated_initializer));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostList")))
@interface SharedPostList : SharedBase
- (instancetype)initWithList:(NSArray<SharedPost *> *)list __attribute__((swift_name("init(list:)"))) __attribute__((objc_designated_initializer));
- (NSArray<SharedPost *> *)component1 __attribute__((swift_name("component1()")));
- (SharedPostList *)doCopyList:(NSArray<SharedPost *> *)list __attribute__((swift_name("doCopy(list:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedPost *> *list __attribute__((swift_name("list")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MainScopeProviderContainerKt")))
@interface SharedMainScopeProviderContainerKt : SharedBase
@property (class, readonly) SharedMainScopeProvider *exportedScopeProvider_mainScopeProvider __attribute__((swift_name("exportedScopeProvider_mainScopeProvider")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("MapExtensionKt")))
@interface SharedMapExtensionKt : SharedBase
+ (NSDictionary<id, id> *)mergeReduce:(NSDictionary<id, id> *)receiver other:(NSDictionary<id, id> *)other reduce:(id _Nullable (^)(id _Nullable, id _Nullable))reduce __attribute__((swift_name("mergeReduce(_:other:reduce:)")));
@end;
...
@interface SharedKoruSuspendWrapper<T> : SharedBase
- (instancetype)initWithScopeProvider:(id<SharedKoruScopeProvider> _Nullable)scopeProvider suspender:(id<SharedKotlinSuspendFunction0>)suspender __attribute__((swift_name("init(scopeProvider:suspender:)"))) __attribute__((objc_designated_initializer));
- (id<SharedKotlinx_coroutines_coreJob>)subscribeOnSuccess:(void (^)(T _Nullable))onSuccess onThrow:(void (^)(SharedKotlinThrowable *))onThrow __attribute__((swift_name("subscribe(onSuccess:onThrow:)")));
- (id<SharedKotlinx_coroutines_coreJob>)subscribeScope:(id<SharedKotlinx_coroutines_coreCoroutineScope>)scope onSuccess:(void (^)(T _Nullable))onSuccess onThrow:(void (^)(SharedKotlinThrowable *))onThrow __attribute__((swift_name("subscribe(scope:onSuccess:onThrow:)")));
@end;
